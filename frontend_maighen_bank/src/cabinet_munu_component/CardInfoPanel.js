...
class CardInfoPanel extends Component {
    constructor(props) {
        super(props);
        this.state = {
            cardNo:"**** **** ****" + this.props.last_four,
            shcardNo:false,
    ...
    handleShowCard() {
        // this.setState({cardNo:this.props.})
    }
    ...
    render() {
        ...
        return (
            <div className="micard">
                <span className="mtitle">Meighen Bank</span>
                <span className="bank-logo">
                        <svg version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink"

                             x="0px" y="0px" width="73.7px" height="40.4px" viewBox="0 0 73.7 40.4"

                             xmlSpace="preserve">
                            <defs>
                            </defs>
                            <g>
                                <path className="st0" d="M37.6,40.4c-8.9-0.1-16.8-1.3-24.3-4.7c-3.6-1.6-7-3.7-9.6-6.7c-5.2-5.9-4.9-12.9,0.6-18.4
                                ...
                                <path className="st0" d="M37.3,37.6c-7.4-0.1-14.2-1.1-20.6-4.1c-3.1-1.4-6-3.3-8.2-5.9c-4.2-4.9-4-10.8,0.5-15.4
                                ...
                                <path className="st0" d="M21.1,23.4c0.6,1.4,1.8,1.9,3,2.3c2.5,0.8,5.1,1.5,7.7,2.2c1,0.3,2,0.6,3,1c0.8,0.4,1.5,0.9,2.2,1.4
                                ...
                                <path className="st0" d="M36.9,15.3c1.1-1.5,2.8-1.9,4.4-2.4c2.5-0.7,4.9-1.4,7.4-2.1c0.8-0.2,1.5-0.5,2.2-0.9c0.7-0.4,1.2-1,1.8-1.6
                                ...
                                <path className="st0" d="M36.9,27.6c-0.4-1.3-1.2-2-2.2-2.4c-2.5-0.8-5-1.5-7.5-2.2c-1.4-0.4-2.8-0.9-4.2-1.4c-1.3-0.5-2-1.5-1.9-3
                ...
                <img className="chip" src="http://jamesdelaney.ie/dev/chip.png" />
                <img className="mc"
                     src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/640px-MasterCard_Logo.svg.png" />
                <span className="holo-back"></span>
                <span className="holo"></span>
                <br />
                <span className="emboss mnumber">{this.state.cardNo}</span><br /><br />
                <span className="small-type">Valid To</span><br /><br />
                <span className="emboss exp">{this.props.validthru}</span><br /><br />
            </div>
